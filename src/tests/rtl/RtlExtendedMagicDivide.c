...
TEST_FUNC(RtlExtendedMagicDivide)
{
    ...
    // Magic number for dividing by 10000000 (100ns to seconds): 0x0000000089705F41, shift=23
    magic_div_test tests[] = {
        // 10000000 / 10000000 = 1 (using magic for div by 10000000)
        { .dividend.QuadPart = 10000000LL, .magic_divisor.QuadPart = 0x89705F4136B4A597LL, .shift_count = 23, .expected_result = 1 },
        // 100000000 / 10000000 = 10
        { .dividend.QuadPart = 100000000LL, .magic_divisor.QuadPart = 0x89705F4136B4A597LL, .shift_count = 23, .expected_result = 10 },
        // 0 / anything = 0
        { .dividend.QuadPart = 0, .magic_divisor.QuadPart = 0x89705F4136B4A597LL, .shift_count = 23, .expected_result = 0 },
